...
const IMAGES = [
  ...
  {
    id: "mario",
    source: require("../../assets/paint/mario.jpg"),
    label: "Mario",
  },
];
...
const Paint = () => {
  const { color, setColor, selectedImage, setSelectedImage } = usePaintStore();
  ...
  const panResponder = PanResponder.create({
    ...
    onPanResponderGrant: (evt: GestureResponderEvent) => {
      ...
      if (
        locationX >= 0 &&
        locationX <= BOUNDART_WIDTH &&
        locationY >= 0 &&
        locationY <= BOUNDART_HEIGHT
      ) {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.paintArea}>
        ...
        <Svg style={[styles.overlay]} {...panResponder.panHandlers}>
          ...
          {currentPath ? (
            <Path d={currentPath} stroke={color} strokeWidth={5} fill="none" />
          ) : null}
        </Svg>
      </View>
      <View style={styles.controls}>
        ...
        <TouchableOpacity style={styles.clearButton} onPress={clearPaint}>
